...
namespace Jellyfin.Plugin.OMDbEnhanced
{
    ...
    public class OmdbProvider
    {
            ...
            where T : BaseItem
        {
            ...
            if ((isEnglishRequested || Plugin.Instance.Configuration.UseGenresForNonEnglish) && !string.IsNullOrWhiteSpace(result.Genre))
            {
        ...
        internal sealed class SeasonRootObject
        {
